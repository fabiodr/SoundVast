/**
 * @flow
 * @relayHash b9dac0ad395988e92c964a4edaae3a35
 */
...
export type playlistModalContainerForwardQueryResponse = {|
  +user: ?{| |};
|};
*/
...
const batch /*: ConcreteBatch*/ = {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "playlistModalContainerForwardQuery",
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
  ...
  "text": "query playlistModalContainerForwardQuery(\n  $count: Int!\n  $cursor: String\n) {\n  user {\n    ...playlistModalContainer_user\n    id\n  }\n}\n\nfragment playlistModalContainer_user on ApplicationUser {\n  playlists(first: $count, after: $cursor) {\n    totalCount\n    edges {\n      cursor\n      node {\n        __typename\n        playlistId\n        name\n        coverImageUrl\n        id\n      }\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n  }\n}\n"
};
