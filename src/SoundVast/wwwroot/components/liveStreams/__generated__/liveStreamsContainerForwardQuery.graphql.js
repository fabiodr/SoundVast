/**
 * @flow
 * @relayHash 71e230db8eeef3d2f9c8b07c19a25ea7
 */
...
export type liveStreamsContainerForwardQueryResponse = {| |};
*/
...
const batch /*: ConcreteBatch*/ = {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "liveStreamsContainerForwardQuery",
    "selections": [
      {
        "kind": "FragmentSpread",
  ...
  "text": "query liveStreamsContainerForwardQuery(\n  $count: Int!\n  $cursor: String\n) {\n  ...liveStreamsContainer\n}\n\nfragment liveStreamsContainer on Query {\n  liveStreams(first: $count, after: $cursor) {\n    edges {\n      node {\n        __typename\n        audioId\n        name\n        coverImageUrl\n        liveStreamUrl\n        likes\n        dislikes\n        id\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n"
};
