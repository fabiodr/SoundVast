/**
 * @flow
 * @relayHash a97e110f824952fb9376bb379eb75c71
 */
...
export type playlistModalContainerQueryResponse = {|
  +user: ?{| |};
|};
*/
...
const batch /*: ConcreteBatch*/ = {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "playlistModalContainerQuery",
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
    ...
    "selections": [
      {
        ...
        "selections": [
          ...
          },
          {
            ...
            "handle": "connection",
            "name": "playlists",
            "key": "playlistModalContainer_playlists",
            "filters": null
          },
          {
            "kind": "ScalarField",
  ...
  "text": "query playlistModalContainerQuery(\n  $count: Int!\n  $cursor: String\n) {\n  user {\n    ...playlistModalContainer_user\n    id\n  }\n}\n\nfragment playlistModalContainer_user on ApplicationUser {\n  playlists(first: $count, after: $cursor) {\n    totalCount\n    edges {\n      cursor\n      node {\n        __typename\n        playlistId\n        name\n        coverImageUrl\n        id\n      }\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n  }\n}\n"
};
