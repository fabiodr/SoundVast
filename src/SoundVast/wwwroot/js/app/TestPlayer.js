...
import {jPlaylist} from "../jPlayer/jPlaylist";
import {jPlayerWrapper} from "../jPlayer/jPlayerWrapper";
...
export default connect()(jPlayerWrapper(jPlaylist(FooterContainer), jPlaylistOptions));