...
const privacyPolicyText = `
  ...
  with how their personally identifiable information is being used online.
  ...
  What personal information does SoundVast collect from the people that
  visit our blog, website or app?
  When using or registering on our site, as appropriate, you may be asked to enter your name,
  email address or other details to help you with your experience.
  When does SoundVast collect information?
  SoundVast collects information from you when using our site, subscribing to a
  newsletter or enter information on our site.
  How does SoundVast use your information?
  SoundVast may use the information we collect from you when you register,
  ...
  How does SoundVast protect visitor information?
  ...
  SoundVast implements a variety of security measures when a user places an order enters,
  ...
  site activity, which enables us to provide you with improved services. We also use cookies
  to help us compile aggregate data about site traffic and site interaction so that we
  ...
  settings. Each browser is a little different, so look at your browser’s Help menu to
  ...
  experience that make your site experience more efficient and some of our services will
  not function properly. However, you can still place orders.
  Third Party Disclosure
  SoundVast does not sell, trade, or otherwise transfer to outside parties your personally
  identifiable information unless we provide you with advance notice. This does not include
  ...
  Third Party Links
  SoundVast does not include or offer third party products or services on our website.
  ...
  If you wish to access or update the Personal Information you submit through our web site,
  or to make any inquiries about the processing of such information, please contact us as
  described below. We provide individuals with access to their Personal Information where
  we believe appropriate, including in situations where you are entitled to access and review
  your Personal Information under applicable data protection and privacy laws.
  Security Measures
  SoundVast maintains appropriate technical and organizational security measures to protect
  the security of your Personal Information against the loss, misuse, unauthorized access,
  ...
  SoundVast will notify the users via email
        • Within 1 business day
  SoundVast will notify the users via in site notification
        • Within 1 business day
`;
