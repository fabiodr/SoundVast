...
namespace SoundVast.Components.Comment
{
    ...
    public class CommentController : CustomBaseController
    {
        ...
        private readonly IRatingService<CommentRatingModel> _ratingService;
        private readonly IReportService<CommentReportModel> _reportService;
        private readonly UserManager<ApplicationUser> _userManager;

        public CommentController(IMapper mapper, IServiceProvider serviceProvider, ICommentService commentService, IAudioService<AudioModel> audioService,
            IRatingService<CommentRatingModel> ratingService, IReportService<CommentReportModel> reportService, UserManager<ApplicationUser> userManager) :
